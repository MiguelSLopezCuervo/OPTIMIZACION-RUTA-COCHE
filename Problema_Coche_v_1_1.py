...
VERSIÓN 1.1:
    ...
    -SE LE PUEDE AÑADIR LO DE QUE SEAN DOS COCHES, QUE SE OPTIMICE PARA Q 
    RECORTE ETC

    -PENSARSE CON QUÉ ALGORITMO OPTIMIZAR ESTO, UNO MÁS POTENTE QUE EL ALEATORIO
    
    -MIRAR SI ESO CÓMO REPRESENTARLO PARA QUE SE VEA MEJOR LA GRÁFICA
    
    -BARAJAR CAMBIAR LA CARRETERA
